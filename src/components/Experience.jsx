  ...
  const activities = [
    {
      ...
      icon: <Users size={16} className="text-teal-600 dark:text-teal-400" />
    },
    {
      role: 'Tech Team Member',
      ...
      icon: <Cpu size={16} className="text-teal-600 dark:text-teal-400" />
    },
    {
      ...
      icon: <Award size={16} className="text-teal-600 dark:text-teal-400" />
    }
  ]

  return (
    <section id="experience" className="py-28 border-t border-zinc-200 dark:border-zinc-900 bg-zinc-50 dark:bg-[#030303] transition-colors">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="mb-16">
          <p className="font-mono text-xs text-teal-600 dark:text-teal-400 uppercase tracking-widest mb-2">06. Engagement</p>
          <h2 className="text-3xl md:text-5xl font-black text-zinc-900 dark:text-white tracking-tight">Experience & Community</h2>
        </div>

        {/* Timeline */}
        <div className="relative border-l-2 border-zinc-200 dark:border-zinc-900 ml-4 pl-8 space-y-12">
          {activities.map((act, idx) => (
            <div key={idx} className="relative group">
              {/* Timeline dot */}
              <span className="absolute -left-[45px] top-1.5 flex items-center justify-center w-8 h-8 rounded-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-850 text-teal-600 dark:text-teal-400 group-hover:border-teal-500 transition-colors">
                {act.icon}
              </span>
              ...
              <div className="p-6 rounded-lg border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-900/10 hover:border-zinc-300 dark:hover:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900/20 transition-all glow-card">
                ...
                <p className="text-sm font-mono text-teal-600 dark:text-teal-400 mb-4">
                  {act.organization}
                </p>
